				...
				<div class="container">
					<div id="responsive-nav">
						<?php 
							...
							$active_cat = isset($_GET['category_name']) ? $_GET['category_name'] : '';
						?>
						<ul class="main-nav nav navbar-nav">
							<li class="<?php echo ($current_page == 'index.php' && $active_cat == '') ? 'active' : ''; ?>">
								<a href="index.php">Home</a>
							</li>

							<li><a href="#hot-deal">Hot Deals</a></li>

							<li class="<?php echo ($active_cat == 'laptop') ? 'active' : ''; ?>">
								<a href="category.php?category_name=laptop">Laptops</a>
							</li>

							<li class="<?php echo ($active_cat == 'smartphone') ? 'active' : ''; ?>">
								<a href="category.php?category_name=smartphone">Smartphones</a>
							</li>

							<li class="<?php echo ($active_cat == 'camera') ? 'active' : ''; ?>">
								<a href="category.php?category_name=camera">Camera</a>
							</li>

							<li class="<?php echo ($active_cat == 'accessories') ? 'active' : ''; ?>">
								<a href="category.php?category_name=accessories">Accessories</a>
							</li>
						</ul>
					</div>
				</div>
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Daffodil Smart City </a></li>
									<li><a href="#"><i class="fa fa-phone"></i>45454454</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>admin@example.com</a></li>
								</ul>
							</div>
						</div>
